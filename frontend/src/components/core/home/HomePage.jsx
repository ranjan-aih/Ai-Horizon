  ...
  return (
    ...
    >
      ...
      <div className='text-center max-w-[1400px] w-full relative z-[1] transform -translate-y-10'>
        <h1
          className='
                !text-[3.5rem] !font-normal !text-[#1a1a1a] !leading-[1.2] !mt-[75px] !mb-[1.5rem]'
        >
          Revolutionizing the {''}
          <span
            className='
                    inline-block text-[4rem] font-semibold leading-[1.1] tracking-[-0.03em] bg-gradient-to-r
                    from-[#FFAA27] to-[#1DFFFF] bg-no-repeat bg-left bg-[length:100%_100%] bg-clip-text
                    text-transparent'
          >
            GenAI
          </span>
        ...
        <p
          className='
                !text-[1.25rem] !text-[#4a4a4a] !leading-[1.6] !mx-auto !mt-0 !mb-[4rem] !font-normal !max-w-[600px]'
        >
          <span className='text-teal-500 text-[1.1em] tracking-[1px] font-normal'>
            ai-
          </span>
          <span className='text-[#FFAC1C] text-[1.1em] tracking-[1px] font-normal'>
            horizon
          </span>
          <span className='text-teal-500 text-[1.1em] tracking-[1px] font-normal'>
            .io{' '}
          </span>
          builds secured, scalable, and customized agentic AI solutions that
          helps enterprises start their AI journey
        </p>
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    'inset 0 4px 4px 0 rgba(0,0,0,0.20), inset 5px -8px 4px 0 rgba(0,0,0,0.05)',
                }}
              />
