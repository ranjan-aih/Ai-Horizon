...
const About1 = () => {
  return (
    <div className='!bg-white !min-h-screen !py-[60px] !px-[20px] ![font-family:Arial,sans-serif] !relative !overflow-hidden'>
      <div
        className="
    absolute top-0 left-0
    w-full h-full
  ...
  "
      ...
      <div className='!max-w-[1200px] !mx-auto !px-[40px] !relative !z-[1]'>
        ...
        <p className='!text-[#333333] !text-[22px] !leading-[1.6] !mb-[30px] !mt-0 !font-normal !text-justify !max-w-[90%]'>
          ...
          we are redefining how AI agents are created and deployed in complex
          enterprise environments. We recognize the challenges that
          organizations face in operationalizing AI-speed, scale, and
          security-we have built a platform that addresses them all.
        </p>
        <p className='!text-[#333333] !text-[22px] !leading-[1.6] !mb-[30px] !mt-0 !font-normal !text-justify !max-w-[90%]'>
          Our mission is simple yet powerful: to make enterprises AI-ready
          through intuitive, scalable, and secure generative AI solutions.
